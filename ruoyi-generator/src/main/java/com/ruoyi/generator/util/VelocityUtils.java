...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("dateFormatStr", "yyyy-MM-dd");
        velocityContext.put("datetimeFormatStr", "yyyy-MM-dd HH:mm:ss");
        // TODO - 手动修改
        velocityContext.put("baseEntity", "BaseEntity");
        velocityContext.put("baseEntityPath", "com.ruoyi.common.core.domain.BaseEntity");
        velocityContext.put("queryFormImportList", getQueryFormImportList(genTable));
    ...
    public static List<String> getTemplateList(String tplCategory, String tplWebType) {
        ...
        templates.add("vm/java/domain-form.java.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        } else if (template.contains("domain-form.java.vm")) {
            fileName = StringUtils.format("{}/domain/dto/form/{}Form.java", javaPath, className);
     ...
     * @return 返回需要导入的包列表
     */
    public static HashSet<String> getQueryFormImportList(GenTable genTable) {
        List<GenTableColumn> columns = genTable.getColumns();
        HashSet<String> importList = new HashSet<String>();
        for (GenTableColumn column : columns) {
            if (column.isQuery()) {
